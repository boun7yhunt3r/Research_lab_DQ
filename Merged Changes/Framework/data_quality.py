...
class DataQualityChecker:
  ...
  #cross check timeshift and how to verify it in our case
  ...
  #each normlaized value need to be between 0 and 1 - recheck on that 
  ...
  def calculate_overall_normalized_relevancy(self, columns_of_interest, outlier_threshold):
